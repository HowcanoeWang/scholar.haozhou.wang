...
\AtDataInput{%
  ...
  \ifentrytype{inproceedings}{\stepcounter{confcount}}{}%
  \ifentrytype{patent}{\stepcounter{patentcount}}{}%
}

% 组合显示 conference 类型（report 或 inproceedings）
\defbibfilter{conference}{%
  type=report or type=inproceedings
}
...
\begin{document}
    ...
    \begin{header}
        ...
        Project Assistant Professor, Laboratory of Field Phenomics, 
    ...
    \section{Featured Projects and Publications}
        ...
        \begin{twocolentry}{
            \textit{\href{https://huggingface.co/datasets/UTokyo-FieldPhenomics-Lab/3DPotatoTwin}{huggingface dataset}}}
            \textbf{3DPotatoTwin dataset}
        \end{twocolentry}

        \vspace{0.10 cm}
        \begin{onecolentry}
            \textit{Dataset intended to help train and benchmark multi-sensory fusion and shape completion algorithms specifically for applications involving actual potato tuber harvesting.}

            \begin{highlights}
                \item \fullcite{wang_3dpotatotwin_2025}；
                \item \textbf{Citations}: 0; \textbf{Reported} by \href{https://www.nikkei.com/nkd/company/article/?DisplayType=11&ng=DGXZRSP698560_U5A021C2000000&scode=6326}{日本日経新聞}
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Broccoli harvest date prediction application}
        \end{twocolentry}
        ...
        \begin{onecolentry}
            ...
            \begin{highlights}
                ...
                \item \textbf{Citations}: 21; \textbf{Reported} by \href{https://www.eurekalert.org/news-releases/1003639}{EurekAlert!}, \href{https://www.nikkei.com/article/DGXZRSP661800_Y3A900C2000000/}{日本日経新聞}, and \href{https://www.bjnews.com.cn/detail/1698978347129712.html}{\textchinese{新京报}}
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{twocolentry}{
            ...
            \textbf{EasyIDP intermediate data processing tool}
        \end{twocolentry}
        ...
        \begin{onecolentry}
            ...
            \begin{highlights}
                ...
                \item \textbf{Citations}: 40; \textbf{Github stars}: 47; \textbf{Tools Used}: Python, PyPi, Readthedocs; 
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{twocolentry}{
            ...
            \textbf{UAV-HiRAP data processing platform}
        \end{twocolentry}
        ...
        \begin{onecolentry}
            ...
            \begin{highlights}
                ...
                \item \textbf{Citations}: 45; \textbf{Tools Used}: Python, Flask, Bootstrap, Nginx; 
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Professional Positions}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Project Assistant Professor}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Greenhouse digital twin crop models.
                \item IoT sensor networks for greenhouse monitoring.
                \item Aerodynamic simulation and optimization for greenhouse structures.
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Aerial sensing system and software toolkit for detecting abnormal potatoes.
    ...
    \section{Publications}
        ...
        \printbibliography[filter=conference, heading=none] % 重置编号
